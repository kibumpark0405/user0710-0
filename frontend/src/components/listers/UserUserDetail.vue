<template>
    <v-card outlined>
        ...
        <v-card-text>
            ...
            <div>
                <String label="Age" v-model="item.age" :editMode="editMode" @change="change" />
            </div>
            <Country offline label="Country" v-model="item.country" :editMode="false" :key="false" @change="change" />
        </v-card-text>
